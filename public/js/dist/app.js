...
(function() {
  ...
  AccountForm = (function() {
    ...
    AccountForm.prototype.submit = function() {
      this.form.on("submit", function(event) {
        ...
        $.post('/accounts', formData).fail(function() {
          ...
          return $('#closeMessage').click(function() {
...
},{"./form":5,"jquery":1}],4:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var DropdownMenu,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  ...
  DropdownMenu = (function() {
    function DropdownMenu(button, elTarget) {
    ...
    DropdownMenu.prototype.click = function() {
    ...
    DropdownMenu.prototype.init = function() {
      this.button.addEventListener("click", this.click, false);
      return true;
    };
...
(function() {
  ...
  Helper = (function() {
    ...
    Helper.floatToDecimal = function(number) {
      var decimalNumber;
      return decimalNumber = parseFloat(number).toFixed(2);
    };

    Helper.parseAmount = function(el, type, amount) {
      switch (type) {
        case "expense":
          el.setAttribute("class", "red-amount amount-cell");
          return el.innerHTML = "-" + this.floatToDecimal(amount);
        case "income":
    ...
    Helper.parseTotal = function(el, amount) {
      if (amount >= 0) {
...
// Generated by CoffeeScript 1.10.0
(function() {
  var $, AccountForm, DropdownMenu, Overlay, Total, Transaction, TransactionForm, addItemMenu, newAccount, newAccountOverlay, newBudgetOverlay, newTransaction, newTransactionOverlay, totalList, transactionTable;
  ...
  newTransactionOverlay = new Overlay("newTransactionOverlay", "addTransactionButton", "closeNewTransaction");

  newTransactionOverlay.init();

  newBudgetOverlay = new Overlay("newBudgetOverlay", "addBudgetButton", "closeNewBudget");
...
},{"./accountForm":3,"./dropdown":4,"./overlay":8,"./total":9,"./transaction":10,"./transactionForm":11,"jquery":1}],8:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var $, Overlay,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
(function() {
  ...
  Total = (function() {
    ...
    Total.prototype.parseTotals = function(data) {
      var budgetBalance, expenseTotal, incomeTotal, networth;
      ...
      return expenseTotal.innerHTML = "- " + data.expense.toFixed(2);
    };

    Total.prototype.getTotals = function() {
      $.get('/totals', this.parseTotals).success().complete(function() {
        $('#totalSpinner').hide();
        return true;
      });
      return true;
...
},{"./helper":6,"jquery":1}],10:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var $, Helper, Transaction, moment,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  ...
  Transaction = (function() {
    function Transaction() {
      this.addMoreTransactions = bind(this.addMoreTransactions, this);
      this.getTransactions = bind(this.getTransactions, this);
      this.parseTransactions = bind(this.parseTransactions, this);
    }

    Transaction.prototype.parseTransactions = function(data) {
      var table;
      table = document.querySelector('#transactionActivity tbody');
      data.map(function(transaction) {
        var accountName, amount, date, description, i, len, my_tag, ref, row, tag, tags;
    ...
    Transaction.prototype.getTransactions = function() {
      $.get('/transactions', this.parseTransactions).fail(function() {}).done(function() {
    ...
    Transaction.prototype.addMoreTransactions = function(number) {
      var transactionRefresh;
      return transactionRefresh = document.getElementById("transactionRefresh");
    };
...
},{"./helper":6,"jquery":1,"moment":2}],11:[function(require,module,exports){
// Generated by CoffeeScript 1.10.0
(function() {
  var $, Form, Helper, TransactionForm, moment,
    bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  ...
  TransactionForm = (function() {
    function TransactionForm(form) {
      this.submit = bind(this.submit, this);
      this.addTransaction = bind(this.addTransaction, this);
      this.init = bind(this.init, this);
      this.accountsUrl = '/accounts';
      this.dateRegExp = /(?:[A-Z]{1}[a-z]{2}\s\d{2}\s\d{4})/;
      this.form = $(form);
    }

    TransactionForm.prototype.init = function() {
      var transactionAccounts;
      transactionAccounts = document.getElementById("newTransactionAccounts");
      $.get(this.accountsUrl, function(data) {
    ...
    TransactionForm.prototype.addTransaction = function(data) {
      var table;
      table = document.querySelector('#transactionActivity tbody');
      return $.get('/transactions/count', function(data) {
        $.get('/transactions/all/' + data, function(data) {
    ...
    TransactionForm.prototype.submit = function() {
      this.form.on("submit", function(event) {
        ...
        $.post('/transactions', formData).fail(function() {
...
},{"./form":5,"./helper":6,"jquery":1,"moment":2}]},{},[7])
