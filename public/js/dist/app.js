...
(function (Helper) {
    function floatToDecimal(float) {
        var decimalNumber = parseFloat(float).toFixed(2);
        return decimalNumber;
    }
    Helper.floatToDecimal = floatToDecimal;
    function parseAmount(el, type, amount) {
        switch (type) {
            case "income":
...
var Total = (function () {
    function Total() {
        ...
        this.parseAllTotals = function (data) {
            ...
            var budgetBalance = document.getElementById("budgetBalance");
            ...
            _this.parseTotal(budgetBalance, data.budget_balance);
...
var TransactionTable = (function () {
    ...
    TransactionTable.prototype.parseData = function (data) {
        var tranTable = document.querySelector("#transactionActivity tbody");
        data.forEach(function (transaction) {
            ...
            Helper_1.Helper.parseAmount(amountCell, transaction.type, transaction.amount);
            ...
            for (var i = 0; i < transaction.tag_names.length; i++) {
